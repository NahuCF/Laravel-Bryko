...
var _loop2 = function _loop2(_i) {
  arrowUp[_i].addEventListener("click", function () {
    arrowDown[_i].classList.toggle("arrow-active");

    arrowUp[_i].classList.toggle("arrow-active");

    applicants[_i].classList.toggle("applicants--visible");
  });
};

for (var _i = 0; _i < arrowUp.length; _i++) {
  _loop2(_i);
}
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\jobs\resources\js\index.js */"./resources/js/index.js");
