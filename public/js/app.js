...
var loginContainer = document.querySelector(".container-login"); // Register

document.querySelector("#btns-register").addEventListener("click", function () {
  registerContainer.classList.toggle("container-register--active");
});
document.querySelector(".register-exit").addEventListener("click", function () {
  registerContainer.classList.toggle("container-register--active");
}); // Login

document.querySelector("#btns-login").addEventListener("click", function () {
...
document.querySelector(".tempora-message-exit").addEventListener("click", function () {
...
__webpack_require__(/*! C:\xampp\htdocs\jobs\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\jobs\resources\css\app.css */"./resources/css/app.css");
